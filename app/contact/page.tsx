                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <a href="https://wa.me/902129630363" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-600 transition-colors inline-flex items-center gap-1">
        ...
        faqItems={[
          {
            ...
            answer: 'You can contact Virtual Riddle by email at info@virtualriddle.com, via WhatsApp from our contact page, or by using the contact form on our website.'
          },
          {
