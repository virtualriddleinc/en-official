                ...
                <div className="bg-white rounded-2xl shadow-md border border-gray-100 p-8">
                  ...
                  <div className="prose prose-lg max-w-none text-gray-700">
                    ...
                    <p className="mt-6 text-gray-600">
                      ...
                      please contact us at <a href="mailto:info@virtualriddle.com" className="text-blue-600 hover:underline">info@virtualriddle.com</a> or by phone at +90 (212) 963 03 63.
                    </p>
                  </div>
                </div>
              </section>
                      ...
                      <div className="text-emerald-800">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                          ...
                          <div className="bg-white p-4 rounded-lg border border-emerald-200 flex items-center">
                            ...
                            <div>
                              <span className="text-sm font-medium text-emerald-900">Phone:</span>
                              <span className="block text-sm text-emerald-700">+90 (212) 963 03 63</span>
                            </div>
                          </div>
