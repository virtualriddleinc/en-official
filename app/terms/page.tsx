                        ...
                        <div className="space-y-4">
                          ...
                          <div className="flex items-start">
                            ...
                            <div>
                              ...
                              <p className="text-gray-600">+90 (212) 963 03 63</p>
                      ...
                      <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                        ...
                        <div className="space-y-4">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600">You can send an email to info@virtualriddle.com or call +90 (212) 963 03 63 for questions about terms of service.</p>
                          </div>
                        </div>
                      </div>
                    </div>
